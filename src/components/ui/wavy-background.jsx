...
// Self-contained fast 3D Simplex noise generator
...
export const WavyBackground = ({
  ...
  return (
    <div
      className={cn(
        "relative flex w-full flex-col items-center justify-center overflow-hidden transition-colors duration-300",
        containerClassName
      )}
    >
      <canvas
